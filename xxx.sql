...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th8 14, 2019 lúc 03:28 PM
...
(4, 'First Blog', 'binh, asd, asd, asd, a, d, a', 'RobloxScreenShot20190529_094121528_1565010009.png', '<p>My first Blog in this website</p>', 35, 'first-blog1565613997', '2019-08-05 13:00:10', '2019-08-12 12:46:37', 'This Is the first blog in this webThis Is the first blog in this webThis Is the first blog in this webThis Is the first blog in this webThis Is the first blog in this webThis Is the first blog in this webThis Is the first blog in this webThis Is the first blog in this webThis Is the first blog in this webThis Is the first blog in this webThis Is the first blog in this webThis Is the first blog in this webfThis Is the first blog in this web'),
(5, 'test', 'abc, xyz, ghi', 'Screenshot (3)_1565097067.png', '<p>this is testing&nbsp;</p>', 23, 'test1565097067', '2019-08-06 13:11:07', '2019-08-10 08:35:48', 'this is testing');
...
(2, 'test 1', 'test-1', 'Oasis Labs, CertiK', '1', '1', '1', '1', 'Unlock', '1', '1', NULL, 2),
(5, 'test3', 'test3', 'Oasis Labs, CertiK, Argoland', '0', '0', '0', '0', 'Lock', '0', '0', NULL, 1);
...
(1, 'Admin', 'admin', '$2y$10$TPL/ltSJEWekpf7CLXW86eK01hPr8qVIFCYe4FuXBd.OGmmWEnDum', 'admin@gmail.com', 'XeNNlAYcAAOQ5zWr8g07EHklVZhqtenqKAK6BcdbWwAtRNe6lveGiZaNH01M', NULL, '2019-08-14 06:23:20', 624),
