...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 27, 2019 lúc 05:54 AM
...
CREATE TABLE `icopool` (
  ...
  `tok-distr` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
