    ...
    <div class="row">
        <div class="col-md-12">
            <div class="kt-portlet">
                ...
                <!--begin::Form-->
                <form class="kt-form" method="post" action="{{route('editlink',$link->id)}}">
                    @csrf
                    <div class="kt-portlet__body">
                        <div class="kt-form__section kt-form__section--first">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    <input type="text" required="" value="{{$link->name}}" class="form-control" placeholder="Enter name" name="name" >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    <input name="link" required=""  value="{{$link->link}}" type="url" class="form-control" placeholder="Enter Link" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    <input name="target"  value="{{$link->target}}" type="text" class="form-control" placeholder="Enter Target" >
                                    <span class="form-text text-muted"></span>
                                </div>
