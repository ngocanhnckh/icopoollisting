                ...
                <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" style="background-image: url(./assets/media/bg/bg-2.jpg);">
                    <div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
                        <div class="kt-login__container">
                            ...
                            <?php
                            if(isset($err)){
                                echo"<div class='kt-alert kt-alert--outline alert alert-danger alert-dismissible animated fadeIn' role='alert'>          <button type='button' class='close' data-dismiss='alert' aria-label='Close'></button>           <span>Incorrect username or password. Please try again.</span>      </div>";
                            }
                            ?>
                            <div class="kt-login__signin">
                                <div class="kt-login__head">
                                    <h3 class="kt-login__title">Forgot pasword</h3>
                                </div>
                                <form class="kt-form" action="{{route('admin-login')}}" method="POST">
                                    ...
                                    <div class="kt-login__actions">
                                        <input type="submit" value="Go"  class="btn btn-brand btn-pill kt-login__btn-primary"/>
                                    </div>
