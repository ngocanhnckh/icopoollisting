    ...
    <div class="kt-portlet" style="overflow: auto;">
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-label">
                ...
                <button onclick="window.location='{{route('addlink')}}'" class="btn btn-outline-success ml-lg-5  ml-2 btn-pill" >+ Add New</button>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$data->link}}</td>
                                 <td>{{$data->target}}</td>
                                <td>
                                    <button onclick="window.location='{{route('editlink',$data->id)}}'"  type="button" class="btn btn-brand btn-elevate btn-pill">
                                        <i class="flaticon-edit"></i>
                                        Edit
                                    </button>
                                    <button onclick="window.location='{{route('xoalink',$data->id)}}'" type="button" class="btn btn-brand btn-elevate btn-pill btn-danger">
