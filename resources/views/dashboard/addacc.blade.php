    ...
    <div class="row">
        <div class="col-md-12">
            <div class="kt-portlet">
                ...
                <!--begin::Form-->
                <form class="kt-form" method="post" action="{{route('addacc')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="kt-portlet__body">
                        <div class="kt-form__section kt-form__section--first">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    <input required=""    type="text" class="form-control" placeholder="Enter account name" name="name" >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    <input required="" class="form-control"   name="email" type="email" class="form-control" placeholder="Enter Email" >
                                    <span class="form-text text-muted"></span>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    <input  value="" name="password" type="password" required="" class="form-control" placeholder="Enter Password" >
                                    <span class="form-text text-muted"></span>
                                </div>
                            </div>
                            <div class="form-group row">
