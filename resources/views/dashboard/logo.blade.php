    ...
    <div class="row">
        <div class="col-md-12">
            <div class="kt-portlet">
                                ...
                                <!--begin::Form-->
                                <form class="kt-form" method="post" action="{{route('logo')}}" enctype="multipart/form-data">
                                    @csrf
                                    <span class="text-muted ml-5">If you don't change logo or thumnail, don't upload</span>
                                    <div class="kt-portlet__body">
                                        <div class="kt-form__section kt-form__section--first">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-4">
                                                    <input name="thumnail" type="file" accept="image/*"class="form-control" >
                                                </div>
                                            </div>
