    ...
    <div class="kt-portlet" style="overflow: auto;">
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-label">
                ...
                <button onclick="window.location='{{route('addacc')}}'" class="btn btn-outline-danger ml-lg-5  ml-2 btn-pill" >+ Add New</button>
            </div>
        </div>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <p>Do pass đã được mã hoá để chống hack nên pass sẽ không hiện ra</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button onclick="window.location='{{route('editacc',$data->id)}}'"  type="button" class="btn btn-brand btn-elevate btn-pill">
                                        <i class="flaticon-edit"></i>
                                        Edit
                                    </button>
                                    <button onclick="window.location='{{route('xoaacc',$data->id)}}'" type="button" class="btn btn-brand btn-elevate btn-pill btn-danger">
