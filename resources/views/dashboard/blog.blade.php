                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button onclick="window.location='{{route('editblog',$data->id)}}'"  type="button" class="btn btn-brand btn-elevate btn-pill">
                                        <i class="flaticon-edit"></i>
                                        Edit
                                    </button>
                                    <button onclick="window.location='{{route('xoablog',$data->id)}}'" type="button" class="btn btn-brand btn-elevate btn-pill btn-danger">
