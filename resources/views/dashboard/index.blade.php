							...
							<div class="row">
								...
								<div class="col-md-6">
									...
									<div class="kt-portlet kt-portlet--fit kt-portlet--head-noborder kt-portlet--height-fluid-half">
										...
										<div class="kt-portlet__body kt-portlet__body--fluid"style="background-image: url('{{asset('public/dashboard/assets/img/bg.png')}}');">


											<div class="kt-widget20">
												<div class="kt-widget20__content kt-portlet__space-x">
													<span class="kt-widget20__number kt-font-danger">{{$admin[0]->view}} View</span>
												</div>
											</div>
										</div>
									</div>
